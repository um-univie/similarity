...
fn bench_cosine_similarity_f32(c: &mut Criterion) {
    ...
    c.bench_function("cosine_similarity", |b| b.iter(|| black_box(cosine_similarity(&slice1, &slice2))) );
}
...
criterion_group!(benches, bench_cosine_similarity_f32, bench_cosine_similarity_f64, bench_cosine_similarity_u8, bench_cosine_similarity_u16, bench_cosine_similarity_u32);
